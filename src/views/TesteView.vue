...
const totalPedidos = computed(() => pedidos.length);
...
const produtosDiferentes = (pedido) => pedido.itens.length;
  ...
  <main class="container page">
    ...
    <section class="card" aria-labelledby="filtro-pedidos">
      ...
      <div class="filter-container">
        ...
        <button class="button button-primary" type="button" @click="aplicarFiltro">
          Filtrar
        </button>
      </div>
    </section>
